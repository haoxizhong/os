...
public  final class Block extends
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000004) == 0x00000004)) {
              transactions_ = new java.util.ArrayList<iiis.systems.os.blockchaindb.Transaction>();
              mutable_bitField0_ |= 0x00000004;
            }
            transactions_.add(
                input.readMessage(iiis.systems.os.blockchaindb.Transaction.parser(), extensionRegistry));
            break;
          }
          case 34: {
            java.lang.String s = input.readStringRequireUtf8();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return iiis.systems.os.blockchaindb.DBProto.internal_static_blockdb_Block_descriptor;
  }

  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return iiis.systems.os.blockchaindb.DBProto.internal_static_blockdb_Block_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            iiis.systems.os.blockchaindb.Block.class, iiis.systems.os.blockchaindb.Block.Builder.class);
  }
  ...
  private java.util.List<iiis.systems.os.blockchaindb.Transaction> transactions_;
  /**
   * <code>repeated .blockdb.Transaction Transactions = 3;</code>
   */
  public java.util.List<iiis.systems.os.blockchaindb.Transaction> getTransactionsList() {
    return transactions_;
  }
  /**
   * <code>repeated .blockdb.Transaction Transactions = 3;</code>
   */
  public java.util.List<? extends iiis.systems.os.blockchaindb.TransactionOrBuilder> 
   ...
   * <code>repeated .blockdb.Transaction Transactions = 3;</code>
   */
  public iiis.systems.os.blockchaindb.Transaction getTransactions(int index) {
    return transactions_.get(index);
  }
  /**
   * <code>repeated .blockdb.Transaction Transactions = 3;</code>
   */
  public iiis.systems.os.blockchaindb.TransactionOrBuilder getTransactionsOrBuilder(
      int index) {
    return transactions_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof iiis.systems.os.blockchaindb.Block)) {
      return super.equals(obj);
    }
    iiis.systems.os.blockchaindb.Block other = (iiis.systems.os.blockchaindb.Block) obj;
  ...
  public static iiis.systems.os.blockchaindb.Block parseFrom(
  ...
  public static iiis.systems.os.blockchaindb.Block parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static iiis.systems.os.blockchaindb.Block parseFrom(
  ...
  public static iiis.systems.os.blockchaindb.Block parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static iiis.systems.os.blockchaindb.Block parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static iiis.systems.os.blockchaindb.Block parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(iiis.systems.os.blockchaindb.Block prototype) {
  ...
  public static final class Builder extends
      ...
      iiis.systems.os.blockchaindb.BlockOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return iiis.systems.os.blockchaindb.DBProto.internal_static_blockdb_Block_descriptor;
    }
    ...
    // Construct using iiis.systems.os.blockchaindb.Block.newBuilder()
    private Builder() {
    ...
    public iiis.systems.os.blockchaindb.Block getDefaultInstanceForType() {
      return iiis.systems.os.blockchaindb.Block.getDefaultInstance();
    }

    public iiis.systems.os.blockchaindb.Block build() {
      iiis.systems.os.blockchaindb.Block result = buildPartial();
    ...
    public iiis.systems.os.blockchaindb.Block buildPartial() {
      iiis.systems.os.blockchaindb.Block result = new iiis.systems.os.blockchaindb.Block(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof iiis.systems.os.blockchaindb.Block) {
        return mergeFrom((iiis.systems.os.blockchaindb.Block)other);
      } else {
    ...
    public Builder mergeFrom(iiis.systems.os.blockchaindb.Block other) {
      if (other == iiis.systems.os.blockchaindb.Block.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      iiis.systems.os.blockchaindb.Block parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (iiis.systems.os.blockchaindb.Block) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private void ensureTransactionsIsMutable() {
      if (!((bitField0_ & 0x00000004) == 0x00000004)) {
        transactions_ = new java.util.ArrayList<iiis.systems.os.blockchaindb.Transaction>(transactions_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        iiis.systems.os.blockchaindb.Transaction, iiis.systems.os.blockchaindb.Transaction.Builder, iiis.systems.os.blockchaindb.TransactionOrBuilder> transactionsBuilder_;
    ...
    public Builder setTransactions(
        int index, iiis.systems.os.blockchaindb.Transaction value) {
      if (transactionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setTransactions(
        int index, iiis.systems.os.blockchaindb.Transaction.Builder builderForValue) {
      if (transactionsBuilder_ == null) {
        ensureTransactionsIsMutable();
     ...
     * <code>repeated .blockdb.Transaction Transactions = 3;</code>
     */
    public Builder addTransactions(iiis.systems.os.blockchaindb.Transaction value) {
      if (transactionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addTransactions(
        iiis.systems.os.blockchaindb.Transaction.Builder builderForValue) {
      if (transactionsBuilder_ == null) {
        ensureTransactionsIsMutable();
    ...
    public Builder addAllTransactions(
        java.lang.Iterable<? extends iiis.systems.os.blockchaindb.Transaction> values) {
      if (transactionsBuilder_ == null) {
        ensureTransactionsIsMutable();
     ...
     * <code>repeated .blockdb.Transaction Transactions = 3;</code>
     */
    public iiis.systems.os.blockchaindb.Transaction.Builder getTransactionsBuilder(
        int index) {
     ...
     * <code>repeated .blockdb.Transaction Transactions = 3;</code>
     */
    public iiis.systems.os.blockchaindb.Transaction.Builder addTransactionsBuilder() {
      return getTransactionsFieldBuilder().addBuilder(
          iiis.systems.os.blockchaindb.Transaction.getDefaultInstance());
    }
    /**
     * <code>repeated .blockdb.Transaction Transactions = 3;</code>
     */
    public iiis.systems.os.blockchaindb.Transaction.Builder addTransactionsBuilder(
        int index) {
      return getTransactionsFieldBuilder().addBuilder(
          index, iiis.systems.os.blockchaindb.Transaction.getDefaultInstance());
    }
    /**
     * <code>repeated .blockdb.Transaction Transactions = 3;</code>
     */
    public java.util.List<iiis.systems.os.blockchaindb.Transaction.Builder> 
         getTransactionsBuilderList() {
      return getTransactionsFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        iiis.systems.os.blockchaindb.Transaction, iiis.systems.os.blockchaindb.Transaction.Builder, iiis.systems.os.blockchaindb.TransactionOrBuilder> 
        getTransactionsFieldBuilder() {
      if (transactionsBuilder_ == null) {
  ...
  private static final iiis.systems.os.blockchaindb.Block DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new iiis.systems.os.blockchaindb.Block();
  }

  public static iiis.systems.os.blockchaindb.Block getDefaultInstance() {
